...
{
    public class EditWarjackViewModel : EditSoloViewModel
    {


        public EditWarjackViewModel() { }


        public EditWarjackViewModel(IList<Ability> abills, IList<Weapon> weapons, IList<Spell> spells)
        {
