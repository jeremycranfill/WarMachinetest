...
{
    public class EditWarlockViewModel : EditSoloViewModel
    {


        public EditWarlockViewModel() { }

        public EditWarlockViewModel(IList<Ability> abills, IList<Weapon> weapons, IList<Spell> spells)
        {
