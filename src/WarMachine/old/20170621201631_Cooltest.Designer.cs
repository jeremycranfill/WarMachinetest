...
namespace WarMachine.Migrations
{
    ...
    [Migration("20170621201631_Cooltest")]
    partial class Cooltest
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("WarMachine.Models.Joins.WarcasterAbility", b =>
                {
                    b.Property<int>("AbilityId");

                    b.Property<int>("WarcasterId");

                    b.HasKey("AbilityId", "WarcasterId");

                    b.HasIndex("AbilityId");

                    b.HasIndex("WarcasterId");

                    b.ToTable("WarcasterAbilities");
                });

            modelBuilder.Entity("WarMachine.Models.Joins.WarcasterSpell", b =>
                {
                    b.Property<int>("SpellId");

                    b.Property<int>("WarcasterId");

                    b.HasKey("SpellId", "WarcasterId");

                    b.HasIndex("SpellId");

                    b.HasIndex("WarcasterId");

                    b.ToTable("WarcasterSpells");
                });

            modelBuilder.Entity("WarMachine.Models.Joins.WarcasterWeapon", b =>
                {
                    b.Property<int>("WeaponId");

                    b.Property<int>("WarcsaterId");

                    b.Property<int?>("WarcasterID");

                    b.HasKey("WeaponId", "WarcsaterId");

                    b.HasIndex("WarcasterID");

                    b.HasIndex("WeaponId");

                    b.ToTable("WarcasterWeapons");
                });
            ...
            modelBuilder.Entity("WarMachine.Models.Joins.WarlockAbillity", b =>
                {
                    b.Property<int>("AbillityId");

                    b.Property<int>("WarlockId");

                    b.HasKey("AbillityId", "WarlockId");

                    b.HasIndex("AbillityId");

                    b.HasIndex("WarlockId");

                    b.ToTable("WarlockAbillities");
                });

            modelBuilder.Entity("WarMachine.Models.Joins.WarlockSpell", b =>
                {
                    b.Property<int>("SpellId");

                    b.Property<int>("WarlockId");

                    b.HasKey("SpellId", "WarlockId");

                    b.HasIndex("SpellId");

                    b.HasIndex("WarlockId");

                    b.ToTable("WarlockSpells");
                });

            modelBuilder.Entity("WarMachine.Models.Joins.WarlockWeapon", b =>
                {
                    b.Property<int>("WeaponId");

                    b.Property<int>("WarlockId");

                    b.HasKey("WeaponId", "WarlockId");

                    b.HasIndex("WarlockId");

                    b.HasIndex("WeaponId");

                    b.ToTable("WarlockWeapons");
                });
            ...
            modelBuilder.Entity("WarMachine.Models.Joins.WarBeastAbillity", b =>
                {
                    b.HasOne("WarMachine.Models.WarModels.Ability", "Ability")
                        .WithMany("WarbeastAbillities")
                        .HasForeignKey("AbilityID");

                    b.HasOne("WarMachine.Models.WarModels.WarBeast", "WarBeast")
                        .WithMany("WarbeastAbiliities")
            ...
            modelBuilder.Entity("WarMachine.Models.Joins.WarcasterAbility", b =>
                {
                    b.HasOne("WarMachine.Models.WarModels.Ability", "Abillity")
                        .WithMany("WarcasterAbillities")
                        .HasForeignKey("AbilityId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("WarMachine.Models.WarModels.Warcaster", "Warcaster")
                        .WithMany("WarcasterAbillities")
            ...
            modelBuilder.Entity("WarMachine.Models.Joins.WarlockAbillity", b =>
                {
                    b.HasOne("WarMachine.Models.WarModels.Ability", "Abillity")
                        .WithMany("WarlockAbillities")
                        .HasForeignKey("AbillityId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("WarMachine.Models.WarModels.Warlock", "Warlock")
                        .WithMany("WarlockAbillities")
